/*
 * Flowdot — CommonJS build by tools/build.js. Do not edit; edit src/ and rebuild.
 * Node/bundler `require('flowdot')` → { …renderer, SceneBuilder, Flow, mount, boot }.
 */
const __api = (function () {
  const __ns = {};
  const globalThis = __ns, module = void 0;
/*
...
(function (global) {
  ...
  return Object.assign({}, __ns.Flowdot, { SceneBuilder: __ns.SceneBuilder, Flow: __ns.Flow });
})();
